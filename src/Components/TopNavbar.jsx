...
export default function EnhancedTwoSectionNavbar() {
    ...
    return (
        <>
            ...
            <div className="bg-gradient-to-r from-slate-900 via-gray-900 to-slate-900 text-white border-b border-gray-800">
                ...
                <div className="max-w-7xl mx-auto px-4 lg:px-8">
                    ...
                    <div className="flex h-16 items-center justify-between">
                        ...
                        <div className="flex items-center lg:hidden">
                            <button
                                className="p-2 rounded-xl hover:bg-gray-100 transition-colors duration-200 mr-2"
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                ...
                                                                {item.subMenu && openSubmenu === item.title && (
                                                                    <div className="absolute left-full top-0 ml-6 w-72 bg-white rounded-2xl shadow-2xl border border-gray-200 p-6 z-50"
